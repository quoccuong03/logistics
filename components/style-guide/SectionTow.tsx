				...
				<div className="text-[10px] lg:text-[14px]">
					<div>
						<b>
							...
							아주 작은 부분입니다. 일부 스타일을 제외하고 컬러로 전반적인 스타일을
					...
					<div>
						<b>
							따라서 스타일 구분을 할때는 전체적인 밸런스를 판단해서 구분하는 것이
							가장 중요합니다.
						</b>
						<br />
						...
						<br /> <b>.각 아이템의 착용방식</b>
						<br /> (착용 위치, 사이즈, 매는, 쓰는, 걸치는,소매 밑단등을 걷는, 단추나
						지퍼 타이등를 푸는)
						<br /> <b>.상의, 하의, 아우터의사이즈를 연출 한 방식 등입니다</b> (사이즈를
						크게 또는 작게 )
					</div>
					<br />
