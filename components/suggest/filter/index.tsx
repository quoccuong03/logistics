...
export default function Filter(props: Props): JSX.Element {
	...
	return (
		<div className="flex mt-[36px] text-[12px]  items-center filter">
			...
			<div className="bg-[#FFA1A1] px-[5px] py-[3px] rounded-[3px] text-[12px] font-bold text-[#fff] ml-[14px] cursor-pointer">
				W
			</div>
			<div className="bg-[#FAFAFA] text-[#999999] px-[5px] py-[3px] rounded-[3px]  text-[12px] font-bold ml-[6px] hover:bg-[#FFA1A1] hover:text-[#fff] cursor-pointer">
				M
			</div>
